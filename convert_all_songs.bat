...
node converter.js songs/home_on_the_range.musicxml --articulation 2 arduino.ino
...
node converter.js songs/olympic_fanfare.musicxml --articulation 2 --append arduino.ino
